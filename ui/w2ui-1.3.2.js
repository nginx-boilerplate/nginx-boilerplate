	...
	w2form.prototype = {
		...
		generateHTML: function () {
			...
			for (var f in this.fields) {
				...
				field.html = $.extend(true, { caption: '', span: 10, attr: '', text: '', page: 0 }, field.html);
				...
				html += '\n   <div class="w2ui-label '+ (typeof field.html.span != 'undefined' ? 'w2ui-span'+ field.html.span : '') +'"><label for="'+ field.name +'">'+ field.html.caption +'</label>:</div>'+
